...
function scrollHeader() {
  ...
  if (this.scrollY >= 200) nav.classList.add("scroll-header", scrollHeader);
...
const getCurrentIcon = () =>
  themeButton.body.classList.contains(iconTheme) ? "bx-moon" : "bx-sun";
...
// Activate / deactivate the theme manuaaly with the button
